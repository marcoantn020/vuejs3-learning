...
<template>
  <header class="banner">
    <div class="apresentacao">
      <img class="logo" src="./../assets/images/logo.svg" alt="Logo do cookie up">
    ...
    <img class="foto-banner"
         src="./../assets/images/foto-banner.png"
         alt="Foto de uma mulher cozinhando com uma bacia de vidro nas maos. Ela esta sorrindo e esta apoiando um celular entre seu rosto e ombro">
  </header>
</template>
